                ...
                <div className="relative z-10 space-y-4">
                    ...
                    <div className="space-y-2">
                        <div className="flex justify-between items-end">
                            <span className="text-xs font-bold text-black/40 uppercase tracking-widest">Step {stepNum} of 6</span>
                            <span className="text-sm font-black text-black">{Math.round((stepNum / 6) * 100)}%</span>
                        </div>
